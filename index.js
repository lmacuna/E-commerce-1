...
const vistaCarro = (carro) => {
    ...
    if (carro.length !== 0) {
        ...
        document.querySelector("#total").innerHTML = `<div style="width:160px;border-radius:11px;height:30px;background:rgb(121, 235, 216);color:black;display:flex;justify-content:center;align-items:center;flex-direction:row">$${total}</div>`
    } else {
        document.querySelector("#carro").innerHTML = ""
    }
}
